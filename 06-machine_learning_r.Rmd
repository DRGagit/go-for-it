...
Wir können nun das in der Variablen `fit` gespeicherte Modell nutzen, und uns die Vorhersagewerte des Modells zu ausgeben. Mit einigen praktischen Befehlen können wir die Vorhersagen auch gleich als neue Spalte dem ursprünglichen Dataframe hinzufügen.
...
Wollen wir diese Grafik noch um weitere wichtige Informationen ergänzen, so können wir auch das einfach erreichen.
